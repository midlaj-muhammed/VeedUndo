      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-4 sm:px-6 py-6 sm:py-12">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-8 text-sm text-[var(--color-text-dim)]">
          ...
          {listing.verified_owner && (
            <span className="inline-flex items-center gap-1 badge bg-green-500/10 text-green-600">
              <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
              Verified
            </span>
          )}
          {listing.quality_score > 0 && (
            <span className="text-xs text-[var(--color-text-dim)]">Quality: {listing.quality_score}/100</span>
          )}
              ...
              {listing.source === "scraped" && listing.source_url && (
                <>
                  <a
                    ...
                    className="flex items-center justify-center gap-2 w-full rounded-full bg-amber-500 text-white hover:bg-amber-600 px-5 py-3 text-sm font-semibold transition-all duration-300 cursor-pointer press-effect min-h-[44px] shadow-sm hover:shadow-md"
                  >
                  ...
                  <p className="text-xs text-[var(--color-text-muted)] text-center">Click above to view listing and contact owner</p>
                </>
              )}
