            ...
            <div className="space-y-3">
              ...
              {listing.source === "scraped" && listing.source_url && (
                <a
                  ...
                  className="flex items-center justify-center gap-2 w-full rounded-full border border-amber-500/30 bg-amber-500/10 text-amber-700 dark:text-amber-400 hover:bg-amber-500/20 px-5 py-3 text-sm font-semibold transition-all duration-300 cursor-pointer press-effect min-h-[44px]"
                >
