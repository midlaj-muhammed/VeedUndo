  ...
  if (error || !listing) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen gap-4">
        <p className="text-lg">{error || "Listing not found"}</p>
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-4 py-8">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          <span className="rounded-full bg-[var(--color-bg)] px-3 py-1 text-sm font-medium border border-[var(--color-border)]">
        ...
        {listing.description && (
          <p className="text-[var(--color-text)] mb-6 whitespace-pre-wrap">
            {listing.description}
          </p>
        )}
        ...
        <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-6 mb-6">
          ...
          {listing.poster_whatsapp && (
            <a
              ...
              className="flex items-center justify-center gap-2 w-full rounded-full bg-[#25D366] px-5 py-3 text-sm font-medium text-white hover:bg-[#1da851] transition-colors mb-3"
            >
          ...
          {listing.poster_phone && (
            <a
              ...
              className="block text-[var(--color-primary)] underline mb-1"
            >
              {listing.poster_phone}
            </a>
          )}
        ...
        <div className="text-center">
          {flagged ? (
            ...
            <button
              onClick={handleFlag}
              disabled={flagging}
              className="text-sm text-[var(--color-text-muted)] hover:text-red-600 underline disabled:opacity-50"
            >
